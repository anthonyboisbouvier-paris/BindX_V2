...
// ---- Mock Target Preview (EGFR) ----
// Realistic data returned by POST /api/v9/target/preview for P00533

export const MOCK_TARGET_PREVIEW_EGFR = {
  uniprot_id: 'P00533',
  protein_name: 'Epidermal growth factor receptor',
  gene_name: 'EGFR',
  organism: 'Homo sapiens',
  sequence_length: 1210,
  function: 'Receptor tyrosine kinase binding ligands in the EGF family and activating several signaling cascades to convert extracellular cues into appropriate cellular responses. Known ligands include EGF, TGFA/TGF-alpha, amphiregulin, epigen/EPGN, BTC/betacellulin, epiregulin/EREG and HBEGF/heparin-binding EGF.',
  ...
  keywords: [
    'Kinase', 'Receptor', 'Tyrosine-protein kinase', 'Membrane', 'Glycoprotein',
    'Disease variant', 'Proto-oncogene', 'Cell membrane',
  ],
  cross_references: {
    pdb: 48,
    drugbank: 6,
  ...
  uniprot_features: {
    domains: [
      { start: 57, end: 168, name: 'Receptor L domain I' },
      { start: 177, end: 338, name: 'Furin-like cysteine-rich domain' },
      { start: 361, end: 481, name: 'Receptor L domain II' },
      { start: 505, end: 637, name: 'Growth factor receptor domain IV' },
      { start: 712, end: 979, name: 'Protein kinase domain' },
    ],
    activeSites: [
      { position: 837, description: 'Proton acceptor' },
    ],
    bindingSites: [
      { position: 721, description: 'ATP binding', ligand: 'ATP' },
      { position: 745, description: 'ATP binding', ligand: 'ATP' },
      { position: 855, description: 'Substrate binding' },
    ],
  },
  structures: [
    {
      ...
      explanation: 'Crystal structure of EGFR kinase domain in complex with erlotinib. Experimentally validated binding site with co-crystallized ligand.',
    },
    {
      ...
      confidence: 0.90,
      recommended: false,
      download_url: 'https://files.rcsb.org/download/4HJO.pdb',
      explanation: 'High-resolution apo structure of EGFR kinase domain. Better resolution but no co-crystallized ligand for pocket validation.',
    },
    {
      source: 'alphafold',
      pdb_id: null,
      ...
      confidence: 0.85,
      recommended: false,
      download_url: 'https://alphafold.ebi.ac.uk/files/AF-P00533-F1-model_v4.pdb',
      explanation: 'AlphaFold predicted structure. Full-length model including transmembrane and extracellular domains. Suitable for pocket detection but less accurate than experimental structures.',
    },
  ],
  pockets: [
    {
      rank: 1,
      method: 'co_crystallized_ligand',
      probability: 0.95,
      residues_count: 34,
      residues: [
        'LEU_718', 'VAL_726', 'ALA_743', 'LYS_745', 'MET_766',
        'LEU_788', 'THR_790', 'GLN_791', 'LEU_792', 'MET_793',
        'PRO_794', 'PHE_795', 'GLY_796', 'CYS_797', 'LEU_844',
        'THR_854', 'ASP_855', 'PHE_856', 'GLY_857', 'LEU_858',
      ],
      center: [10.5, 20.3, 15.1],
      volume: 487.2,
      selected: true,
      explanation: 'ATP-binding pocket defined by co-crystallized erlotinib (AQ4). Experimentally validated binding site — gold standard for docking.',
    },
    {
      rank: 2,
      method: 'p2rank',
      ...
      residues_count: 22,
      residues: [
        'ILE_759', 'ASP_761', 'ALA_763', 'LEU_764', 'HIS_805',
        'GLY_810', 'CYS_811', 'ARG_812', 'ASP_813', 'LEU_814',
        'VAL_815', 'TYR_827', 'VAL_834', 'THR_835', 'ASP_837',
      ],
      center: [5.2, 28.1, 22.4],
      volume: 312.8,
      selected: false,
      explanation: 'Allosteric pocket detected by P2Rank ML model. Located near the activation loop — potential allosteric modulation site.',
    },
    {
      rank: 3,
      method: 'fpocket',
      ...
      residues_count: 18,
      residues: [
        'GLU_734', 'SER_735', 'MET_742', 'ASN_756', 'ASP_770',
        'ARG_776', 'GLU_780', 'HIS_781', 'ASP_784', 'GLY_785',
      ],
      center: [18.7, 15.6, 8.3],
      volume: 198.5,
      selected: false,
      explanation: 'Secondary pocket detected by fpocket geometric algorithm. Moderate druggability — may require further validation.',
    },
  ],
  chembl_info: {
    has_data: true,
    ...
    description: 'EGFR is one of the most extensively studied drug targets with over 15,000 known active compounds.',
  },
}
