      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
          <div className="flex items-center gap-3">
            <div className="p-2 rounded-xl bg-[#1e3a5f] text-white">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
                  d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M16.5 12L12 16.5m0 0L7.5 12m4.5 4.5V3" />
              </svg>
            </div>
            <h2 className="font-bold text-[#1e3a5f] text-lg">Export Molecules</h2>
          </div>
          <button
            onClick={onClose}
              ...
              {SCOPE_OPTIONS.map(opt => {
                ...
                return (
                  ...
                  >
                    ...
                    />
                    <span className={`text-sm font-medium ${scope === opt.value ? 'text-[#1e3a5f]' : 'text-gray-700'}`}>
                      {opt.label}
                    </span>
                ...
                <button
                  ...
                  className={`flex flex-col items-center gap-2 py-4 rounded-xl border-2 transition-all ${
                    format === f.value
                      ...
                      : 'border-gray-100 text-gray-500 hover:border-blue-200 hover:bg-blue-50/20 hover:text-[#1e3a5f]'
                  }`}
                >
                  {f.icon}
                ...
                {[
                  ...
                  >
                    <input
                      ...
                      className="accent-[#1e3a5f]"
                    />
                    <span className={`text-sm font-medium ${csvColumns === opt.value ? 'text-[#1e3a5f]' : 'text-gray-700'}`}>
                      {opt.label}
                    </span>
        ...
        <div className="px-6 py-4 border-t border-gray-100 bg-gray-50 flex items-center justify-end gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 px-5 py-2 rounded-xl text-sm font-semibold
                       bg-[#1e3a5f] hover:bg-[#2d5a8e] text-white transition-colors
