...
function DownloadButton({ href, label, icon, variant = 'blue', description }) {
  ...
  const variantClasses = variant === 'green'
    ? 'bg-bx-mint hover:bg-bx-mint-dim text-white'
  ...
  return (
    ...
    >
      ...
      <div className="text-left">
        ...
        {description && (
          <div className="text-sm opacity-75 font-normal">{description}</div>
        )}
      </div>
    </a>
  )
  ...
  return (
    <div className="card p-5">
      ...
      <div className="flex items-center gap-2 mb-4">
        <svg className="w-5 h-5 text-bx-light-text" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
            d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
        </svg>
        <h3 className="font-semibold text-bx-light-text">Download Results</h3>
      </div>

      {/* Summary info */}
      <div className="flex items-center gap-4 mb-4 p-3 bg-green-50 rounded-lg border border-green-100">
        <div className="w-8 h-8 bg-bx-mint rounded-full flex items-center justify-center flex-shrink-0">
      ...
      <div className="mt-4 grid grid-cols-2 gap-2">
        <div className="p-2.5 bg-gray-50 rounded-lg">
          <p className="text-sm font-semibold text-gray-600 mb-1">The PDF report contains:</p>
        ...
        <div className="p-2.5 bg-gray-50 rounded-lg">
          <p className="text-sm font-semibold text-gray-600 mb-1">The ZIP archive contains:</p>
          <ul className="text-sm text-gray-400 space-y-0.5">
