        ...
        >
          ...
          <div className="flex items-center justify-between px-3 pt-3 pb-2 border-b border-gray-100">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={showAll}
                className="text-[10px] text-bx-light-text hover:text-[#1a2332] transition-colors font-medium"
              >
                Show all
              </button>
            </div>
                  ...
                  <div className="flex items-center gap-1.5 px-3 py-1.5 bg-gray-50/80">
                    ...
                    <div className="flex items-center gap-1">
                      <button
                        ...
                        className="text-[9px] text-gray-400 hover:text-bx-light-text transition-colors px-1"
